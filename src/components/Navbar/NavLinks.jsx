...
//             <HashLink className="
//     relative text-sm inline-block font-semibold text-black hover:text-orange-600
...
const NavLinks = () => {
    ...
    const linkStyles = "relative text-sm inline-block font-semibold text-black hover:text-orange-600 after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-300 after:ease-out  hover:after:w-full";
